...
void map_1_exe(char *klkl)
{
    ...
    //loop
    const Sint16 c0x[4] = {117, 185, 80, 80};
    const Sint16 c0y[4] = {80, 240, 200, 100};
    const Sint16 c1x[4] = {360, 390, 180, 250};
    const Sint16 c1y[4] = {250, 365, 400, 320};
    const Sint16 c2x[4] = {500, 390, 470, 550};
    const Sint16 c2y[4] = {250, 365, 400, 320};
    const Sint16 c3x[4] = {370, 490, 440, 117};
    const Sint16 c3y[4] = {120, 180, 60, 80};
    const Sint16 c4x[4] = {185, 250, 360, 260};
    const Sint16 c4y[4] = {240, 320, 250, 170};
    const Sint16 c5x[4] = {185, 80, 180, 250};
    const Sint16 c5y[4] = {240, 200, 400, 320};
    const Sint16 c6x[5] = {117, 185, 260, 370 } ;
    const Sint16 c6y[5] = {80, 240, 170, 120};
    const Sint16 c7x[4] = {370, 490, 500, 420};
    const Sint16 c7y[4] = {120, 180, 250, 210};
    const Sint16 c8x[4] = {260, 360, 420, 370};
    const Sint16 c8y[4] = {170, 250, 210, 120};
    const Sint16 c9x[4] = {360, 390, 500, 420};
    const Sint16 c9y[4] = {250, 365, 250, 210};
///////////////
    while(shallExit == SDL_FALSE)
    {
        ...
        filledPolygonColor(sdlRenderer, c4x, c4y, 4, c[4].main_color);
